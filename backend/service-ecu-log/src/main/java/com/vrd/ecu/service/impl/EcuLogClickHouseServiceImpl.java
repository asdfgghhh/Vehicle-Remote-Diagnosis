...
public class EcuLogClickHouseServiceImpl implements EcuLogClickHouseService {
    ...
    public PageResult<EcuLogRecord> search(Integer current, Integer size, String vin, String ecuType,
        ...
        try {
            ...
            List<EcuLogRecord> records = this.bigDataClient.queryForList(
                    SELECT_COLUMNS + where + " ORDER BY upload_start_time DESC LIMIT " + pageSize + " OFFSET " + offset,
                    EcuLogRecord.class);
    ...
    public void insertRecord(EcuLogRecord record) {
        ...
        json.put("log_start_time", this.formatDateTime(record.getLogStartTime()));
        json.put("log_end_time", this.formatDateTime(record.getLogEndTime()));
        json.put("upload_start_time", this.formatDateTime(record.getUploadStartTime()));
        json.put("upload_end_time", this.formatDateTime(record.getUploadEndTime()));
    ...
    public EcuLogRecord getById(Long id) {
        List<EcuLogRecord> list = this.bigDataClient.queryForList(
    ...
    public boolean existsByMd5(String fileMd5) {
        ...
        return this.bigDataClient.queryCount(
