...
public class AuthController {
    ...
    public Result<TokenIntrospectResponse> introspectToken(@RequestParam("token") String token) {
        ...
        try {
            ...
            response.setExpiresAt(jwtUtil.getExpirationDateFromToken(jwt).getTime());
